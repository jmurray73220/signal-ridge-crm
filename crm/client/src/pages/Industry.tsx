...
export function Industry() {
  ...
  const handleExport = async () => {
    try {
      ...
      a.href = url; a.download = 'industry.csv'; a.click();
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-semibold" style={{ color: '#e6edf3' }}>Industry</h1>
          ...
          <table className="w-full">
            <thead>
              <tr style={{ borderBottom: '1px solid #30363d' }}>
                {['Name', 'Industry', 'Contract Vehicles', 'Contacts', 'Active Initiatives', 'Last Meeting Note'].map(h => (
